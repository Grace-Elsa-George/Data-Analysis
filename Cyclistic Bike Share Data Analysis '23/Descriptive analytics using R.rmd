...
Visualizations are useful to share the findings and key insights of the analysis to the stake holders. Tableau and Power BI are used to create the visualizations and dashboard. 

Initially, the cleaned dataset is loaded into Tableau/PowerBI in a new workbook. Then variety of charts are created.
